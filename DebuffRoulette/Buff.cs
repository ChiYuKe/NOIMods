...
namespace DebuffRoulette
{
    ...
    internal class Buff
    {
        ...
        public static void Register(ModifierSet parent)
        {
            ...
            new KModEffectConfigurator("shuailao", 1920f, false)
               .SetEffectName("衰老")
               .SetEffectDescription("人老难免有不中用的时候")
               .AddAttributeModifier(attributes.Athletics.Id, -6f, false, false, true)// 运动
               .AddAttributeModifier(attributes.Strength.Id, -6f, false, false, true)//力量
               .AddAttributeModifier(attributes.Digging.Id, -6f, false, false, true)// 挖掘
